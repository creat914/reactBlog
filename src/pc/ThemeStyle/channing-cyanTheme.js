...
.markdown-body img {
    ...
    object-fit: contain;
    box-shadow: 0 0 16px hsla(0, 0%, 43.1%, .45)
}
...
.markdown-body tr:nth-child(2n) {
    background-color: rgba(77, 208, 225, .05)
}
...
.markdown-body blockquote:before {
    content: "鉂漒 ";top:8px;left:8px;color:#4dd0e1;font-size:30px;line-height:1;font-weight:700;position:absolute;opacity:.7}.markdown-body blockquote:after{content:"鉂瀄";
    font-size: 30px;
    position: absolute;
    right: 8px;
    bottom: 0;

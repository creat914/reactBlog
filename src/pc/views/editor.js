...
const editor = (props) => {
  ...
  const themeSelect = (e)=>{
    ...
    if(hasSelThemeList[e]){
      ...
      import(`../ThemeStyle/${e}Theme.js`).then(({default:styleName})=>{
        themeStyle.innerHTML = styleName;
        hasSelThemeList[e] = styleName
      })
    }
  }
        ...
        <div className={eiditorModules["header-fixed"]}>
          <div className={eiditorModules["header-container"]}>
            ...
            <div className={eiditorModules["avatar"]}>
              ...
              <div className={state ? eiditorModules["options"] : [`${eiditorModules['options'],`${eiditorModules["hidden"]}`}`].join(" ")}>
